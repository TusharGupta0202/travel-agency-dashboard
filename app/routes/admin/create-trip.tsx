...
const CreateTrip = ({loaderData}:Route.ComponentProps) => {
  ...
  return (
    <main className='flex flex-col gap-10 pb-20 wrapper'>
        <Header title='Add a new trip' description='View and edit AI Generated travel plans'></Header>
                    ...
                    <div key={key }>
                        ...
                        <ComboBoxComponent
                            ...
                            filtering={(e)=>{
                                ...
                                e.updateData(
                                    comboBoxItems[key].filter((items) => items.toLowerCase().includes(query)).map(((item) => ({
                                        text : item,
                                        value : item
                                    })))
                                )
