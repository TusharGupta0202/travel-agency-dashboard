...
const TripDetail = ( {loaderData} : Route.ComponentProps) => {
    ...
    const { name , duration , itinerary, travelStyle, groupType, budget, estimatedPrice, 
        interests, description, bestTimeToVisit, weatherInfo, country } = tripData || {};
            ...
            <section className="container wrapper-md">
                <header>
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        />
                        <InfoPill 
                            text={itinerary?[...new Set(itinerary.map(item => item.location))].join(', ') : ''}
